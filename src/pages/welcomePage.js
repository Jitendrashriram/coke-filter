                    ...
                    <div className="fl-col">
                        {challengeLink ? (
                            ...
                            link ? (
                                ...
                                <>
                                <p className="welcome__text">
                                Welcome to Gong Xi Fa Cai! Your loved one XXX wants to play the Coca-Cola Family Reunion Trivia Challenge with you.
                                </p>
                                <p className="welcome__text">
                                Please key in the answers to the 5 questions for your loved one to guess later!
                                </p>
